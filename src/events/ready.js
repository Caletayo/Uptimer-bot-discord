...
module.exports = {
  async execute(client) {
    client.on("ready", () => {
      const activities = [
        { name: `${client.guilds.cache.size} Servidores`, type: 2 }, // LISTENING
        { name: `${client.channels.cache.size} Canales`, type: 0 }, // PLAYING
        { name: `${client.users.cache.size} Usuarios en total`, type: 3 }, // WATCHING
        { name: `😎 | Uptimer tick | Caletapons development`, type: 5 } // COMPETING
      ];
      const status = [
        'online',
        'dnd',
